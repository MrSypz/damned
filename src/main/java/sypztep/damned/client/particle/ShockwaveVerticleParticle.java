...
public class ShockwaveVerticleParticle extends VerticalSpriteBillboardParticle {
    protected ShockwaveVerticleParticle(ClientWorld world, double x, double y, double z, SpriteProvider spriteProvider, double velocityX, double velocityY, double velocityZ) {
    ...
    public record Factory(SpriteProvider sprites) implements ParticleFactory<SimpleParticleType> {
        public Particle createParticle(SimpleParticleType type, ClientWorld world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            // Example usage
            ShockwaveVerticleParticle particle = new ShockwaveVerticleParticle(world, x, y, z, sprites, xSpeed, ySpeed, zSpeed);
